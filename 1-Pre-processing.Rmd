...
#TODO: Add something about tf-idf weighting
...
BONUS: we can use `rTextTools` to go directly from dataframe to DTM, completing pre-processing stems automatically. If you read your corpus using Option 1 above (Section 1.1) you must first convert your corpus into a dataframe.
