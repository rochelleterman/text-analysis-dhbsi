...
```{r}
# Load Data
sonnets.df <- read.csv('shakes-sonnets.csv', header=FALSE, sep="\t", as.is=TRUE)
...
documents<-Corpus(DirSource("Data/Toy_Corpora/POS-fiction"))
...
The "pos" function returns a great deal of information, including not only the text itself, but full sentences in which each word appears with its tag, and counts of the tags themselves. We'll use the list of tags to compute bigram frequencies.
